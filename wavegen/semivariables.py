...
class semivariables:
    ...
    def get_random_xaxis():
        return semivariables.__get_random_element_from_array(semivariables.xAxisLabels)
    
    @staticmethod
    def get_random_yaxis():
        return semivariables.__get_random_element_from_array(semivariables.yAxisLabels)
    
    @staticmethod
    def get_random_discipline():
        return semivariables.__get_random_element_from_array(semivariables.disciplines)